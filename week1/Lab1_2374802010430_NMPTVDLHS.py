...
Original file is located at
    https://colab.research.google.com/drive/1FwvgS9zhDTcBXBLkOXO-YaFZAog4AnCm
"""
...
#4.thống kê dữ liệu thiếu cho cột dân tộc và hiệu chỉnh dữ liệu thiếu như sau: Mặc định thiếu thì điền giá trị
...
#6.Hãy thực hiện xử lý lần lượt tất cả dữ liệu thiếu cho các biến về điểm số còn lại.Hãy thực hiện xử lý lần lượt tất cả dữ liệu thiếu cho các biến về điểm số còn lại.
